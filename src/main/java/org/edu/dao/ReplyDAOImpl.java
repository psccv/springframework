...
public class ReplyDAOImpl implements IF_ReplyDAO {
	...
	private static String namespace = "org.edu.mapper.ReplyMapper";
	...
	@Override
	public void deleteAllReply(Integer bno) throws Exception {
		session.update(namespace + ".deleteAllReply", bno);
	}
